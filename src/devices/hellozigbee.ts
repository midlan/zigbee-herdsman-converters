...
const addSwitchCfgCluster = m.deviceAddCustomCluster("genOnOffSwitchCfg", {
    ...
    attributes: {
        switchMode: {name: "switchMode", ID: 0xff00, type: Zcl.DataType.ENUM8, manufacturerCode, write: true},
        relayMode: {name: "relayMode", ID: 0xff01, type: Zcl.DataType.ENUM8, manufacturerCode, write: true},
        maxPause: {name: "maxPause", ID: 0xff02, type: Zcl.DataType.UINT16, manufacturerCode, write: true},
        minLongPress: {name: "minLongPress", ID: 0xff03, type: Zcl.DataType.UINT16, manufacturerCode, write: true},
        longPressMode: {name: "longPressMode", ID: 0xff04, type: Zcl.DataType.ENUM8, manufacturerCode, write: true},
        operationMode: {name: "operationMode", ID: 0xff05, type: Zcl.DataType.ENUM8, manufacturerCode, write: true},
        interlockMode: {name: "interlockMode", ID: 0xff06, type: Zcl.DataType.ENUM8, manufacturerCode, write: true},
    },
    commands: {},
    commandsResponse: {},
});
